...
function MyAccount() {
	...
	//
	useEffect(() => {}, [user, listPassword]);
	const setLstPassword = (index, value) => {
		listPassword[0] = value;
		setListPassword(listPassword);
	};
											...
											<>
												<Form.Group className='mb-3' controlId='email'>
													...
													<Form.Control
														type='email'
														onChange={(event) =>
															setLstPassword(0, event.target.value)
														}
														required
														placeholder='Enter email address'
												...
												<Form.Group className='mb-3' controlId='email'>
													...
													<Form.Control
														type='email'
														onChange={(event) =>
															setLstPassword(1, event.target.value)
														}
														required
														placeholder='Enter email address'
												...
												<Form.Group className='mb-3' controlId='email'>
													...
													<Form.Control
														type='email'
														onChange={(event) =>
															setLstPassword(2, event.target.value)
														}
														required
														placeholder='Enter email address'
